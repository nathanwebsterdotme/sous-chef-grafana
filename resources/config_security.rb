...
action :install do
  ...
  node.run_state['sous-chefs'][new_resource.instance_name]['config']['security']['cookie_secure'] ||= '' unless new_resource.allow_embedding.nil?
  node.run_state['sous-chefs'][new_resource.instance_name]['config']['security']['cookie_secure'] << new_resource.allow_embedding.to_s unless new_resource.allow_embedding.nil?
end
